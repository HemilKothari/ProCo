...
import com.example.proco.Matches.MatchesAdapter;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    if (dataSnapshot.child("lastMessage").getValue() != null && dataSnapshot.child("lastTimeStamp")
                        ...
                        mLastTimeStamp = dataSnapshot.child("lastMessage").getValue().toString();
...
private void getUserMatchId() {
    Query sortedMatchLastStamp = FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId)
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            if (dataSnapshot.exists()) {
                for (DataSnapshot match : dataSnapshot.getChildren()) {
                    FetchMatchIformation(match.getKey(), match.child("Chatid").toString());
                }
            }
        }
...
private String convertMilliToRelative(Long now){
       String time= DateUtils.getRelativeDateTimeString(this, now, DateUtils.SECOND_IN_MILLIS,DateUtils.WEEK_IN_MILLIS,DateUtils.FORMAT_ABBREV_ALL)
               .toString();
        return time;
}
