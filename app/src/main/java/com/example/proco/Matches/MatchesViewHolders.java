...
import com.example.proco.ChatActivity;
...
public class MatchesViewHolders extends RecyclerView.ViewHolder implements View.OnClickListener
{
...

    {
        ...
        mMatchImage=(ImageView) itemView.findViewById(R.id.profileid);
    ...
    {
        Intent intent=new Intent(view.getCotext(), ChatActivity.class);
        Bundle b=new Bundle();
        ...
        intent.putExtra(b);
        view.getCotext().startActivity(intent);
